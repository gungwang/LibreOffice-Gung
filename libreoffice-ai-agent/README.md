...
- `scripts/verify_sidebar_openrouter_writer_proposal.ps1` installs the OXT and live-verifies a real OpenRouter-backed Writer replacement proposal plus approval flow for a non-heuristic rewrite prompt
