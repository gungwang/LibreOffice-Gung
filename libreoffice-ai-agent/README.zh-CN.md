...
- `scripts/verify_sidebar_invalid_selection.ps1` 安装 OXT，并在真实 LibreOffice 中验证 sidecar 请求发出前的本地拒绝流程；默认检查 Writer“未选中文本”校验，配合 `-Scenario unsupported-document` 也可以验证 Calc 中“仅支持 Writer”的本地拒绝，且不修改表格内容
